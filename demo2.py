...
txt4.insert(1, "row 0 column 0")

txt5 = Entry(bd=2)
txt5.grid(row=1, column=1,sticky=N)
txt5.insert(1, "row 0 column 1")

txt6 = Entry(bd=2)
txt6.grid(row=1, column=2,sticky=N)
txt6.insert(1, "row 1 column 2")

txt7 = Entry(bd=2)
txt7.grid(row=2, column=0,sticky=N)
txt7.insert(2, "row 3 column 0")

txt8 = Entry(bd=2)
txt8.grid(row=2, column=1,sticky=N)
txt8.insert(2, "row 2 column 1")

txt9 = Entry(bd=2)
txt9.grid(row=2, column=2,sticky=N)
txt9.insert(2, "row 2 column 2")
